...
# Shotgun metagenomics with mouse (GRCm39 + PhiX) depletion
PIPELINE_NAME="taxprofiler_mouse_01"
...
hostremoval_reference: "$NEXTFLOW_DIR/db/hostremoval/grcm39phix.fa"
shortread_hostremoval_index: "$NEXTFLOW_DIR/db/hostremoval/grcm39phix"
perform_longread_qc: true
perform_longread_hostremoval: true
longread_hostremoval_index: "$NEXTFLOW_DIR/db/hostremoval/grcm39phix.mmi"
run_kraken2: true
run_bracken: true
run_metaphlan: true
run_krona: true
